...
def compress_context(
    ...
    *,
    ...
    try:
        ...
        # Restore a real user turn BEFORE the task marker below: the marker
        # is always role="user", so appending it first would satisfy this
        # guard's "already has a user turn" check and skip restoring the
        # actual dropped request, silently losing it (see #55677 test that
        # pins the restored content verbatim).
